...
# creating duplex link between two nodes where 12Mb - data rate and 100 ms is the delay
...
$ns duplex-link $n16 $n15 12Mb 100ms DropTail
$ns duplex-link $n17 $n15 12Mb 100ms DropTail
$ns duplex-link $n18 $n15 12Mb 100ms DropTail
$ns duplex-link $n15 $n13 12Mb 100ms DropTail
$ns duplex-link $n20 $n19 12Mb 100ms DropTail
$ns duplex-link $n21 $n19 12Mb 100ms DropTail
$ns duplex-link $n19 $n13 12Mb 100ms DropTail
...
$ns at 5.0 "$cbr9 stop"
$ns at 0.5 "$cbr16 start"
$ns at 5.0 "$cbr16 stop"
$ns at 0.5 "$cbr17 start"
$ns at 5.0 "$cbr17 stop"
$ns at 0.5 "$cbr18 start"
$ns at 5.0 "$cbr18 stop"
$ns at 0.5 "$cbr20 start"
$ns at 5.0 "$cbr20 stop"
$ns at 0.5 "$cbr21 start"
$ns at 5.0 "$cbr21 stop"
